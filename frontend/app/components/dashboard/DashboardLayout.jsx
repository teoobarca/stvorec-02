...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-white/5 backdrop-blur-2xl border-r border-white/10 z-50 transform transition-transform duration-300 lg:translate-x-0 ${
